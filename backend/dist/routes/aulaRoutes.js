...
const cleanupOnError = (req, res, next) => {
    ...
    res.end = function (chunk, ...args) {
        ...
        if (statusCode >= 400 && req.file) {
            try {
                console.log(`Limpando arquivo temporário devido a erro: ${req.file.path}`);
...
router.post("/", cleanupOnError, upload.single("videoFile"), handleMulterError, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        if (req.file) {
            try {
                console.log(`Iniciando upload do vídeo ${req.file.originalname} (${Math.round(req.file.size / 1024 / 1024)}MB) para o Google Drive`);
                ...
                return res.status(500).json({
                    ...
                    details: (_a = uploadError.message) !== null && _a !== void 0 ? _a : "Erro desconhecido no upload",
                });
            }
        }
        ...
        const novaAula = yield aulaService.create({
            titulo,
            urlVideo,
            moduloId: parseInt(moduloId),
        });
...
router.post("/with-activity", upload.none(), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newAula = yield aulaService.createWithActivity({
...
router.post("/upload-preview", cleanupOnError, upload.single("videoFile"), handleMulterError, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!req.file) {
            return res
                .status(400)
        ...
        console.log(`Iniciando upload de preview do vídeo ${req.file.originalname} (${Math.round(req.file.size / 1024 / 1024)}MB) para o Google Drive`);
        // Faz o upload do vídeo para o Google Drive sem associar a uma aula específica
        const googleDriveUrl = yield aulaService.uploadVideo(req.file);
...
router.post("/:id/video", cleanupOnError, upload.single("videoFile"), handleMulterError, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const videoUrl = yield aulaService.uploadVideo(req.file, aulaId);
        // Buscar a aula atualizada
        const updatedAula = yield prismaClient_1.default.aula.findUnique({
            where: { id: aulaId },
        });
...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const aulas = yield aulaService.findAll();
        res.json(aulas);
    }
    catch (error) {
...
router.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const aula = yield aulaService.findById(Number(req.params.id));
        if (aula) {
            res.json(aula);
        }
        else {
...
router.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const aula = yield aulaService.update(Number(req.params.id), req.body);
        res.json(aula);
    }
    catch (error) {
...
router.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield aulaService.delete(Number(req.params.id));
        res.status(204).send();
    }
    catch (error) {
